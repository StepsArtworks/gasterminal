...
export function PanoramaViewer({ location, onBackToMap }: PanoramaViewerProps) {
  ...
  const getNavigationHotspotsForLocation = (locationName: string): NavigationHotspot[] => {
    switch (locationName) {
        ...
        return [
          {
            ...
            target: {
              name: 'LPG Area 2',
              imageUrl: 'https://tbrhub.com/gasterminal/images/lpg2.jpg',
              description: 'LPG Area 2 - Secondary storage and monitoring systems',
              equipment: ['Pressure Vessels', 'Control Systems', 'Safety Equipment', 'Monitoring Panels'],
              initialRotation: 100
            }
          }
        ];
        ...
        return [
          {
            ...
            target: {
             ...
             description: 'LPG Area 1 - Primary storage bullet tank system',
          ...
          },
          {
            ...
            target: {
              name: 'LPG Area 3',
              imageUrl: 'https://tbrhub.com/gasterminal/images/lpg3.jpg',
              description: 'LPG Area 3 - Distribution and transfer systems',
              equipment: ['Transfer Lines', 'Distribution Manifolds', 'Emergency Systems', 'Control Valves'],
              initialRotation: 135
            }
          }
        ];
        ...
        return [
          {
            ...
            latitude: 0,
            target: {
              name: 'Workshop Area 2',
              imageUrl: 'https://tbrhub.com/gasterminal/images/workshop2.jpg',
              description: 'Workshop Area 2 - Main work area and equipment storage',
              equipment: ['Work Benches', 'Tool Storage', 'Equipment Racks', 'Safety Equipment'],
              initialRotation: 90
            }
          },
          {
            ...
            latitude: 0,
            target: {
              name: 'Workshop Area 3',
              imageUrl: 'https://tbrhub.com/gasterminal/images/workshop3.jpg',
              description: 'Workshop Area 3 - Kitchen and entrance to lab and offices',
              equipment: ['Kitchen Facilities', 'Lab Entrance', 'Office Access', 'Break Area'],
              initialRotation: 135
            }
          }
        ];
      
      case 'Workshop Area 2':
        return [
          {
            id: 'to-workshop-1',
            longitude: 90,
            ...
            target: {
              ...
              imageUrl: 'https://tbrhub.com/gasterminal/images/workshop1.jpg',
              description: 'Workshop Area 1 - Main entrance and reception area',
      ...
      case 'Workshop Area 3':
        return [
          {
            id: 'back-to-workshop-1',
            longitude: 90,
            latitude: 0,
            target: {
              name: 'Workshop Area 1',
          ...
          },
          {
            ...
            target: {
              name: 'Laboratory',
             imageUrl: 'https://tbrhub.com/gasterminal/images/lab.jpg',
              description: 'Laboratory facility for testing and analysis',
              equipment: ['Testing Equipment', 'Analysis Tools', 'Safety Equipment', 'Sample Storage'],
              initialRotation: 0
            }
          },
          {
            ...
            target: {
              ...
              imageUrl: 'https://tbrhub.com/gasterminal/images/wsoffice1.jpg',
              description: 'Workshop administrative office area',
              equipment: ['Workstations', 'Meeting Rooms', 'Filing Systems', 'Communication Equipment'],
              initialRotation: 0
            }
          }
        ];
        ...
        return [
          {
            ...
            target: {
              name: 'MCC Room',
              imageUrl: 'https://tbrhub.com/gasterminal/images/substation1.jpg',
              description: 'Motor Control Center and electrical substation',
              equipment: ['Motor Control Centers', 'Electrical Panels', 'Switchgear', 'Control Systems'],
              initialRotation: 0
            }
          },
          {
            id: 'to-water-suppression',
            longitude: -25,
            latitude: 0,
            target: {
              name: 'Water Suppression Room',
              imageUrl: 'https://tbrhub.com/gasterminal/images/piperoom.jpg',
              description: 'Water suppression and pipe systems room',
              equipment: ['Fire Suppression Systems', 'Water Pumps', 'Pipe Networks', 'Control Valves'],
              initialRotation: 90
            }
          },
          {
            ...
            target: {
              name: 'Air Pump Room',
              imageUrl: 'https://tbrhub.com/gasterminal/images/airpump.jpg',
              description: 'Air compression and pump systems',
              equipment: ['Air Compressors', 'Pump Systems', 'Pressure Vessels', 'Control Equipment'],
              initialRotation: 270
            }
          }
        ];
        ...
        return [
          {
            ...
            target: {
              ...
              imageUrl: 'https://tbrhub.com/gasterminal/images/utilitybuilding.jpg',
          ...
          },
          {
            ...
            latitude: 0,
            target: {
              name: 'Substation Area 2',
              imageUrl: 'https://tbrhub.com/gasterminal/images/substation2.jpg',
              description: 'Secondary electrical substation and distribution systems',
              equipment: ['Distribution Panels', 'Transformers', 'Electrical Controls', 'Safety Systems'],
              initialRotation: 0
            }
          }
        ];
      
      case 'Substation Area 2':
        return [
          {
            id: 'back-to-mcc',
            longitude: -90,
      ...
      case 'Workshop Office 1':
        return [
          ...
          },
          {
            ...
            latitude: 0,
            target: {
              name: 'Workshop Office 2',
              imageUrl: 'https://tbrhub.com/gasterminal/images/wsoffice2.jpg',
              description: 'Secondary workshop office space',
              equipment: ['Additional Workstations', 'Storage', 'Meeting Area', 'Equipment'],
              initialRotation: 0
            }
          }
        ];
      
      case 'Workshop Office 2':
        return [
          {
            id: 'back-to-office-1',
            longitude: 170,
  ...
  useEffect(() => {
    ...
    let mouseX = 0;
    let mouseY = 0;
    let lon = currentPanorama.initialRotation || 0; // Initialize with the panorama's initial rotation
    let lat = 0;

    // Set initial camera rotation based on location
    ...
    <div className="relative w-full h-full bg-black">
      ...
      <div className="absolute inset-0 pointer-events-none z-10">
        ...
        {navigationHotspots.map((hotspot) => {
          ...
          // Debug logging for Workshop Office 1
          if (currentPanorama.name === 'Workshop Office 1') {
          ...
          return (
            <div
              key={hotspot.id}
              className="absolute transform -translate-x-1/2 -translate-y-1/2 group pointer-events-auto z-20"
              style={{ left: `${position.x}px`, top: `${position.y}px` }}
              onClick={() => handleNavigationClick(hotspot)}
            >
              {/* Navigation arrow */}
              <div className="w-12 h-12 rounded-full bg-blue-600 hover:bg-blue-700 border-4 border-white flex items-center justify-center cursor-pointer transition-all duration-200 hover:scale-110 shadow-2xl animate-pulse">
